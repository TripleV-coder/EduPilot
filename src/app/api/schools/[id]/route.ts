...
const updateSchoolSchema = z.object({
  ...
  emailDomain: z.string().regex(/^[a-z0-9.-]+\.[a-z]{2,}$/i, "Domaine invalide").nullable().optional(),
  logo: z.string().url("URL du logo invalide").nullable().optional(),
  motto: z.string().max(140, "La devise est trop longue").nullable().optional(),
  mempCode: z.string().max(32, "Le code MEMP est trop long").nullable().optional(),
  primaryColor: z.enum(["brand", "success", "warning", "danger", "accent"]).nullable().optional(),
