...
export const cepSubjects: ExamSubject[] = [
    { code: "FRA", name: "Français", coefficient: 3, isPractical: false },
    { code: "MAT", name: "Mathématiques", coefficient: 3, isPractical: false },
    { code: "SDM", name: "Sciences", coefficient: 2, isPractical: false },
    { code: "EPS", name: "Éducation Physique", coefficient: 1, isPractical: true },
    { code: "EAR", name: "Éducation Artistique", coefficient: 1, isPractical: true },
];

// Matières BEPC avec coefficients
export const bepcSubjects: ExamSubject[] = [
    { code: "FRA", name: "Français", coefficient: 2, isPractical: false },
    { code: "MAT", name: "Mathématiques", coefficient: 3, isPractical: false },
    { code: "ANG", name: "Anglais", coefficient: 2, isPractical: false },
    { code: "SVT", name: "SVT", coefficient: 2, isPractical: false },
    { code: "PCT", name: "Physique-Chimie", coefficient: 2, isPractical: false },
    { code: "HGE", name: "Histoire-Géographie", coefficient: 2, isPractical: false },
    { code: "EPS", name: "Éducation Physique", coefficient: 1, isPractical: true },
];
...
export class ExamPrepService {
    ...
    async analyzeStudentReadiness(
        ...
        const examSubjects = examType === "CEP" ? cepSubjects : bepcSubjects;
        ...
        const overallAvg = subjectReadiness.length > 0
            ? subjectReadiness.reduce((a, b) => a + b.averageScore, 0) / subjectReadiness.length
            : 0;

        const overallReadiness = Math.min(100, Math.round((overallAvg / 20) * 100));

        // Prédiction de succès (simplifiée)
