            ...
            <AnimatePresence>
                {!isOpen && (
                    <motion.button
                        ...
                        className="fixed bottom-6 right-6 w-14 h-14 bg-gradient-to-br from-primary to-purple-600 rounded-full shadow-lg flex items-center justify-center text-white z-50"
                    >
            ...
            <AnimatePresence>
                {isOpen && (
                    <motion.div
                        ...
                        className={cn(
                            "fixed bottom-6 right-6 w-96 bg-background border rounded-2xl shadow-2xl z-50 overflow-hidden flex flex-col",
                            isMinimized && "h-auto"
                        )}
                    >
                        {/* Header */}
                                ...
                                <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-muted/30">
                                    ...
                                    {isLoading && (
                                        <div className="flex justify-start">
                                            <div className="bg-background border px-4 py-3 rounded-2xl rounded-bl-sm">
