...
const App = () => {
  ...
  React.useEffect(() => {
    ...
    document.documentElement.setAttribute('data-period', tw.periodSystem || 'trimestre');
    window.__periodSystem = tw.periodSystem || 'trimestre';
  ...
  }, [tw.palette, tw.theme, tw.density, tw.displayFont, tw.bodyFont, tw.periodSystem]);
  ...
  return (
    <>
      <DesignCanvas>
        ...
        <DCSection id="value-add" title="14 · Valeur ajoutée · spécifique Bénin" subtitle="Trim/sem · WhatsApp · offline · QR · annales · bourses · clubs · RH · alumni · bien-être · vocal · OHADA · benchmark · wallet · cagnottes">
          ...
          <DCArtboard id="wellbeing" label="Cellule d'écoute & bien-être — signalement anonyme" width={1280} height={1080}>
            <WellbeingPage/>
          </DCArtboard>
          <DCArtboard id="voice" label="Notifications vocales multilingues — Fon, Yoruba, Bariba" width={1280} height={1080}>
            <VoiceNotifsPage/>
          </DCArtboard>
          <DCArtboard id="accounting" label="Comptabilité OHADA & caisse — journal & DGI" width={1280} height={1060}>
            <AccountingPage/>
          </DCArtboard>
          <DCArtboard id="benchmark" label="Benchmark national MEMP — positionnement 4 280 collèges" width={1280} height={1080}>
            <BenchmarkPage/>
          </DCArtboard>
          <DCArtboard id="wallet" label="Wallet école Mobile Money — MTN, Moov, Celtiis, Ecobank" width={1280} height={1080}>
            <WalletPage/>
          </DCArtboard>
          <DCArtboard id="cagnotte" label="Cagnottes & pots communs — sorties scolaires" width={1280} height={1020}>
            <CagnottePage/>
          </DCArtboard>
        </DCSection>
      ...
      <TweaksPanel title="Tweaks · EduPilot">
        ...
        <TweakSection label="Année académique · système">
          <TweakRadio label="Découpage" value={tw.periodSystem} options={['trimestre', 'semestre']}
            onChange={v => setTweak('periodSystem', v)}/>
          <div style={{ fontSize: 11, color: 'var(--text-tertiary)', lineHeight: 1.5, marginTop: 4 }}>
            Choisissez selon votre établissement. Tous les bulletins, conseils, dashboards et bulletins parents s'adaptent automatiquement.
          </div>
        </TweakSection>
      </TweaksPanel>
    </>
