...
- **N52** : `/api/students/bulk-import`, second point d'entrée d'import d'élèves, appelé par aucun écran et non couvert par N46. Il rattache un parent à l'élève par simple email, sans vérification : c'est précisément le chemin écarté par N50. Décision à prendre : retrait, ou alignement sur N46/N50.
- **N54** : import des élèves, la colonne « Adresse » est proposée et acceptée, mais jamais enregistrée (`StudentProfile.address` existe), sans avertissement. **Décision à prendre (données personnelles, règle 11)** : l'enregistrer, ou la retirer et la signaler comme N50.
...
| N52 | Moyenne | `/api/students/bulk-import` : second import d'élèves, appelé par aucun écran, non couvert par N46 ; rattache un parent à l'élève par simple email, sans vérification (le chemin écarté par N50) | Suivi — décision : retrait ou alignement sur N46/N50 | Constat Lot 5 | — | recherche des appels ; lecture du code | — | — |
...
| N54 | Moyenne | Import des élèves : colonne « Adresse » proposée et acceptée, jamais enregistrée (`StudentProfile.address` existe), sans avertissement | Décision du propriétaire (données personnelles) : l'enregistrer, ou la retirer et la signaler comme N50 | Constat Lot 5 | — | lecture du code (`mapping-utils.ts`, `student-import.ts`) | — | — |
