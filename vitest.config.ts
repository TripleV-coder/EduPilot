...
export default defineConfig({
  test: {
    ...
    coverage: {
      ...
      //  - src/app/api/**    : seuil TD-005 (23/18/23 au 2026-08-16, +61
      //    tests : teachers/[id], payments/[id]/invoice, grades/councils +
      ...
      thresholds: {
        ...
        'src/app/api/**': { statements: 23, branches: 18, functions: 23 },
      },
    },
    testTimeout: 10000,
  },
